...
public class DialogAnadirManzana extends DialogFragment {
    public static final String TAG = DialogAnadirManzana.class.getSimpleName();
    ...
    public static DialogAnadirManzana newInstance(String idManzana, ArrayList<FusionItem> manzanas){
        Bundle arg = new Bundle();
        arg.putString(ID,idManzana);
        //arg.putInt(IDACCION,idAcccion);
        manzanaSeleccionada = manzanas;
        DialogAnadirManzana frag = new DialogAnadirManzana();
